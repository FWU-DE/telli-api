...
import { handler as v1_admin_organizations_$organizationId_$projectId_putHandler } from "./organizations/$organizationId/projects/$projectId/put";
...
export const adminRouteHandlerDefinitions: Array<RouteHandlerDefinition> = [
  ...
  },
  {
    ...
    method: "PUT",
    schema: { hide: true },
    handler: v1_admin_organizations_$organizationId_$projectId_putHandler,
  },
  {
